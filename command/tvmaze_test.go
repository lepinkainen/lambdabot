...
func TestTVMaze(t *testing.T) {
	...
	tests := []struct {
		...
		{"Mandalorean", args{args: "mandalorean"}, "Next episode of The Mandalorian 2x02 'Chapter 10: The Confrontation' airs 2020-11-06 on Disney+", false},
		...
		{"Doctor Who", args{args: "doctor who"}, "Next episode of Doctor Who 12x00 'Revolution of the Daleks' airs 2020-12-25 on BBC One", false},
	}
